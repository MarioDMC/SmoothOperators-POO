            ...
            <table align="center">
                ...
                <tr>
                    ...
                    <td class="pj-table-cell-editable"><span class="pj-table-cell-label" style="display: none;">1</span>
                        <label>
                            <input type="text" data-name="name" class="form-control pj-selector-editable" value="1"
                                   style="">
                        </label></td>
                    <td class="pj-table-cell-editable"><span class="pj-table-cell-label" style="display: none;">1</span>
                        <label>
                ...
                <tr>
                    ...
                    <td class="pj-table-cell-editable"><span class="pj-table-cell-label" style="display: none;">2</span>
                        <label>
                            <input type="text" data-name="name" class="form-control pj-selector-editable" value="2"
                                   style="">
                        </label></td>
                    <td class="pj-table-cell-editable"><span class="pj-table-cell-label" style="display: none;">2</span>
                        <label>
                ...
                <tr>
                    ...
                    <td class="pj-table-cell-editable"><span class="pj-table-cell-label" style="display: none;">3</span>
                        <label>
                            <input type="text" data-name="name" class="form-control pj-selector-editable" value="3"
                                   style="">
                        </label></td>
                    <td class="pj-table-cell-editable"><span class="pj-table-cell-label" style="display: none;">3</span>
                        <label>
                ...
                <tr>
                    ...
                    <td class="pj-table-cell-editable"><span class="pj-table-cell-label" style="display: none;">4</span>
                        <label>
                            <input type="text" data-name="name" class="form-control pj-selector-editable" value="4"
                                   style="">
                        </label></td>
                    <td class="pj-table-cell-editable"><span class="pj-table-cell-label" style="display: none;">4</span>
                        <label>
                ...
                <tr>
                    ...
                    <td class="pj-table-cell-editable"><span class="pj-table-cell-label" style="display: none;">5</span>
                        <label>
                            <input type="text" data-name="name" class="form-control pj-selector-editable" value="5"
                                   style="">
                        </label></td>
                    <td class="pj-table-cell-editable"><span class="pj-table-cell-label" style="display: none;">5</span>
                        <label>
