    ...
    <%@include file="shared/sidebar.jsp" %>
            ...
            <div class="container-fluid">
                <div class="jumbotron-fluid">
                    <table class="table">
                        ...
                        <tr>
                            <td><%--@declare id="check"--%><label for="check"><input type="checkbox" name=""></label>
                            </td>
                            ...
                            <td class="pj-table-cell-editable"><span class="pj-table-cell-label"
                                ...
                                <label>
                                    <a href="" class="btn btn-success btn-outline btn-sm m-l-xs pj-table-icon-edit">
                                        <img src="<c:url value="/resources/img/check.png"/>" class="icon"
                                             alt="icon.pnh">
                                        Activo
                                    </a>
                                </label></td>
                            <td class="pj-table-cell-editable"><span class="pj-table-cell-label"
                                ...
                                <label>
                                    <a href="" class="btn btn-success btn-outline btn-sm m-l-xs pj-table-icon-edit">
                                        <img src="<c:url value="/resources/img/bloquear.png"/>" class="icon"
                                             alt="bloquear.png">
                                        Desbloqueado
                                    </a>
                                </label></td>
                            <td>
                                <div class="m-t-xs text-right">
                                    <a href="" class="btn btn-primary btn-outline btn-sm m-l-xs pj-table-icon-edit">
                                        <img src="<c:url value="/resources/img/fa%20fa-pencil.png"/>" class="icon"
                                             alt="icon.png">
                                    </a>
                            <td>
                                <a href="" class="btn btn-danger btn-outline btn-sm m-l-xs pj-table-icon-delete">
                                    <img src="<c:url value="/resources/img/fa%20fa-trash.png"/>" class="icon"
                                         alt="icon.png">
                                </a>
                            </td>
                    </table>
        ...
        <div class="form-popup" id="myForm">
            <form action="" class="form-container">
                ...
                <input type="tel" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" placeholder="Ingrese Telefono" name="tel"
                       required>
